...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes,stride=1, dilation=1,
                 downsample = None, BatchNorm=None) -> None:
        super().__init__()
...
class ResNet(nn.Module):
    def _make_layer(self, block:Bottleneck, planes, blocks:int, stride=1,dilation=1, BatchNorm=None):
        downsample = None
    ...
    def _make_MG_unit(self, block:Bottleneck, planes, blocks, stride=1, dilation=1, BatchNorm=None):
        downsample = None
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                nn.Conv2d(
    ...
    def _load_pretrained_model(self, imagenet_pretrained_path:str):
...
def ResNet101(output_stride, BatchNorm,pretrained=True, imagenet_pretrained_path=""):
    model = ResNet(
        Bottleneck,
        [3,4,23,3],
        output_stride,
